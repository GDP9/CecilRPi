...
public class CecilParser extends Parser {
	...
	// $ANTLR start "program"
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:123:1: program : ( instruction )* ;
	public final void program() throws RecognitionException {
		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:124:3: ( ( instruction )* )
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:124:5: ( instruction )*
			{
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:124:5: ( instruction )*
			loop1:
			while (true) {
	...
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:127:1: instruction : ( '.' labelfield )? instructiondata ;
	public final void instruction() throws RecognitionException {
		ParserRuleReturnScope labelfield1 =null;

		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:128:3: ( ( '.' labelfield )? instructiondata )
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:128:5: ( '.' labelfield )? instructiondata
			{
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:128:5: ( '.' labelfield )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:128:6: '.' labelfield
					{
	...
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:138:1: labelfield : ( 'start' | NAME );
	public final CecilParser.labelfield_return labelfield() throws RecognitionException {
		...
		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:139:3: ( 'start' | NAME )
	...
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:142:1: instructiondata : ( ( binaryinstruction datafield ) | unaryinstruction );
	public final void instructiondata() throws RecognitionException {
		...
		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:143:3: ( ( binaryinstruction datafield ) | unaryinstruction )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:143:5: ( binaryinstruction datafield )
					{
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:143:5: ( binaryinstruction datafield )
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:143:6: binaryinstruction datafield
					{
					...
					break;
				case 2 :
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:163:5: unaryinstruction
					{
	...
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:170:1: unaryinstruction : ( 'stop' | 'print' | 'printch' | 'printb' | 'printd' | 'cclear' | 'cset' | 'lshift' | 'rshift' | 'pull' | 'xdec' | 'xinc' | 'xpull' | 'xpush' | 'ydec' | 'yinc' | 'ypull' | 'ypush' | 'push' ) ;
	public final CecilParser.unaryinstruction_return unaryinstruction() throws RecognitionException {
		...
		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:171:3: ( ( 'stop' | 'print' | 'printch' | 'printb' | 'printd' | 'cclear' | 'cset' | 'lshift' | 'rshift' | 'pull' | 'xdec' | 'xinc' | 'xpull' | 'xpush' | 'ydec' | 'yinc' | 'ypull' | 'ypush' | 'push' ) )
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:
			{
	...
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:175:1: binaryinstruction : ( 'add' | 'sub' | 'and' | 'comp' | 'xor' | 'or' | 'jineg' | 'jicarry' | 'jipos' | 'jizero' | 'jmptosr' | 'jump' | 'load' | 'xload' | 'yload' | 'xstore' | 'ystore' | 'loadmx' | 'store' | 'xcomp' | 'insert' | 'return' | 'ycomp' ) ;
	public final CecilParser.binaryinstruction_return binaryinstruction() throws RecognitionException {
		...
		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:176:3: ( ( 'add' | 'sub' | 'and' | 'comp' | 'xor' | 'or' | 'jineg' | 'jicarry' | 'jipos' | 'jizero' | 'jmptosr' | 'jump' | 'load' | 'xload' | 'yload' | 'xstore' | 'ystore' | 'loadmx' | 'store' | 'xcomp' | 'insert' | 'return' | 'ycomp' ) )
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:
			{
	...
	// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:181:1: datafield : ( NAME | ( DIGIT )+ );
	public final CecilParser.datafield_return datafield() throws RecognitionException {
		...
		try {
			// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:182:3: ( NAME | ( DIGIT )+ )
			int alt5=2;
			...
			switch (alt5) {
				case 1 :
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:182:5: NAME
					{
					match(input,NAME,FOLLOW_NAME_in_datafield309); 
					}
					break;
				case 2 :
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:183:5: ( DIGIT )+
					{
					// C:\\Users\\Shreeprabha\\Dropbox\\GDP\\CecilRPi\\src\\org\\raspberrypi\\cecil\\model\\Cecil.g:183:5: ( DIGIT )+
					int cnt4=0;
					loop4:
